...
**Last updated:** 24 August 2026 (urgent hotfix — duplicate game rows on save; round-notes pre-fill folded into same chunk; migration applied to production D1; awaiting human localhost review before commit)
...
Priority hotfix in progress (see Hotfix log above) — duplicate game rows on save. Code complete, tested, reviewed, and migration applied to production D1. Awaiting human localhost review, then commit and push/merge sign-off, before Wave 6 resumes.
