...
```
inline-block py-3 -my-3        /* default — reaches a 44px target on text-sm */
inline-block py-2.5 -my-2.5    /* where line height is tight — ~40px */
```
...
**Target:** 44px where the surrounding layout allows it. ~40px is acceptable for links sitting inline within flowing paragraph text, where more vertical padding would risk overlapping adjacent lines.
